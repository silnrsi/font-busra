...
The current version is 9.300. It contains six weights and can be downloaded from the [project releases page](https://github.com/silnrsi/font-busra/releases). There are no oblique (italic) styles in this release. They will be added in a future release.
