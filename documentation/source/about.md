...
Busra is based on a font that was part of a larger package of Khmer script fonts called Mondulkiri; previous names were “Khmer Mondulkiri book” and “Khmer Busra”. The weight of the original Busra was been found to be the most generally appropriate for normal text, compared to other fonts in the older package, and serves as the basis for this Busra Regular font. Several significant changes exist between the earlier forms of the font in the Mondulkiri package and this Busra font.
